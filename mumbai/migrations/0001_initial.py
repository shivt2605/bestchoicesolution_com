    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('call_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mumbai.call_status')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mumbai.status')),
            ],
        ),
        migrations.CreateModel(
            name='Interested',
            fields=[
                ...
                ('call_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mumbai.call_status')),
                ('response', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mumbai.response')),
            ],
        ),
        migrations.CreateModel(
            name='For_Job',
