    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('call_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='noida.call_status')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='noida.status')),
            ],
        ),
        migrations.CreateModel(
            name='Interested',
            fields=[
                ...
                ('call_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='noida.call_status')),
                ('response', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='noida.response')),
            ],
        ),
        migrations.CreateModel(
            name='For_Job',
