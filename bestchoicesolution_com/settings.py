...
SECRET_KEY = 'django-insecure-(*e_y5ei3+idj38*x_%&ry%hcp4bvhc+#0dw6+%w%%hib5m*gg'
...
ROOT_URLCONF = 'bestchoicesolution_com.urls'
...
WSGI_APPLICATION = 'bestchoicesolution_com.wsgi.application'
